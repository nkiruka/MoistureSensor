...
Sensor.create!([
  ...
  {name: "Sensor 3", description: "moisture", model: "Y-161"},
  {name: "Sensor 4", description: "moisture", model: "Y-161"},
  {name: "Sensor 5", description: "moisture", model: "Y-161"},
  {name: "Sensor 6", description: "moisture", model: "Y-161"},
  {name: "Sensor 7", description: "moisture", model: "Y-161"},
  {name: "Sensor 8", description: "moisture", model: "Y-161"},
  {name: "Sensor 9", description: "moisture", model: "Y-161"},
  {name: "Sensor 10", description: "moisture", model: "Y-161"},
  {name: "Sensor 11", description: "moisture", model: "Y-161"},
  {name: "Sensor 12", description: "moisture", model: "Y-161"}
])
